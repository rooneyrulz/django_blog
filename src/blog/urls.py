...
from .views import blog_home_view, blog_list_view, blog_create_view, blog_details_view, blog_edit_view, blog_about_view
...
urlpatterns = [
	...
	path('details/<int:id>/edit/', blog_edit_view, name='blog_edit_view'),
